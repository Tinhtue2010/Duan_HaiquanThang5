...
class YeuCauHangVeKhoController extends Controller
{
    ...
    {
        return view('quan-ly-kho.yeu-cau-hang-ve-kho.danh-sach-yeu-cau-hang-ve-kho');
    }
    ...
    */
    public function duyetYeuCauHangVeKho(Request $request)
    {
        try {
            ...
            if ($yeuCau) {
                ...
                $soToKhaiNhaps = YeuCauHangVeKhoChiTiet::where('ma_yeu_cau', $request->ma_yeu_cau)->pluck('so_to_khai_nhap')->unique();
    ...
    public function thayDoiCongChucHangVeKho(Request $request)
    {
        ...
        TheoDoiHangHoa::where('cong_viec', 5)
