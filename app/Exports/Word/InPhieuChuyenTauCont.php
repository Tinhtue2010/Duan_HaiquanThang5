...
class InPhieuChuyenTauCont
{
    public function inPhieuChuyenTauCont($ma_yeu_cau)
    {
        $yeuCau = YeuCauTauCont::find( $ma_yeu_cau);

        $chiTiets = YeuCauTauContChiTiet::where('yeu_cau_tau_cont_chi_tiet.ma_yeu_cau', $ma_yeu_cau)
            ->get();
        ...
        $cell1->addText('V/v: “chuyển hàng sang container mới, tàu mới  ”', ['italic' => true, 'size' => 12], ['alignment' => 'center']);
        ...
        // Add the title
        $section->addText('ĐỀ NGHỊ CHUYỂN HÀNG SANG CONTAINER MỚI, TÀU MỚI', ['bold' => true, 'size' => 14], ['alignment' => 'center']);
        ...
        foreach ($chiTiets as $chiTiet) {
            ...
            $table->addCell(3000, ['valign' => 'center'])->addText(
                $chiTiet->so_container_goc . " (" . $chiTiet->tau_goc . ")",
                ['size' => 10],
                ['alignment' => 'center']
            );
            $table->addCell(3000, ['valign' => 'center'])->addText(
            ...
            $table->addCell(3000, ['valign' => 'center'])->addText(
                $chiTiet->so_container_dich . " (" . $chiTiet->tau_dich . ")",
                ['size' => 10],
                ['alignment' => 'center']
            );
            $table->addCell(3000, ['valign' => 'center'])->addText(
