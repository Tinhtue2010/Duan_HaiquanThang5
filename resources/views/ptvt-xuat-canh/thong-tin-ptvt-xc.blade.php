                ...
                <div id="divPrint">
                    ...
                    <div class="row mt-4 justify-content-center">
                        ...
                        <div class="col-5">
                            ...
                            <p class="fs-5"><strong>Draft :</strong> {{ $phuong_tien_vt->draft }}</p>
                            <p class="fs-5"><strong>DWT :</strong> {{ $phuong_tien_vt->dwt }}</p>
                        </div>
                        <div class="col-1"></div>
                        <div class="col-5">
                            ...
                            <p class="fs-5"><strong>LOA :</strong>{{ $phuong_tien_vt->loa }}</p>
                            <p class="fs-5"><strong>Breadth :</strong>{{ $phuong_tien_vt->breadth }}</p>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('phuong-tien-vt.huy-to-khai-ptvt-xc') }}" method="POST">
                    ...
                    <div class="modal-body text-danger">
                        ...
                        <input name="so_ptvt_xuat_canh" type="hidden" value="{{ $phuong_tien_vt->so_ptvt_xuat_canh }}" />
                    </div>
