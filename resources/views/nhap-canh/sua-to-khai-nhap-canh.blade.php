    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
                    ...
                    <div class="card px-3 pt-3 mt-4">
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <select class="form-control" id="ptvt-xc-dropdown-search" name="ptvtxc">
                                            <option selected value="{{ $nhapCanh->so_ptvt_xuat_canh }}">
                                                {{ $nhapCanh->PTVTXuatCanh->ten_phuong_tien_vt }} Số:
                                                {{ $nhapCanh->so_ptvt_xuat_canh }}
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group mt-3">
                                        <label class="label-text mb-1 fw-bold" for="">Chọn thuyền trưởng (Hoặc
                                            nhập tên khác trong ô tìm kiếm)</label>
                                        <select class="form-control" id="thuyen-truong-dropdown-search"
                                            ...
                                            @foreach ($thuyenTruongs as $thuyenTruong)
                                                <option value="{{ $thuyenTruong }}"
                                                    @if ($thuyenTruong == $thuyenTruong) selected @endif>
                                                    {{ $thuyenTruong }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-4">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="dd/mm/yyyy"
                                            ...
                                            value="{{ \Carbon\Carbon::parse($nhapCanh->ngay_dang_ky)->format('d/m/Y') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <center>
                                    <div class="toggle-container">
                                        <label class="toggle-switch">
                                            <input type="checkbox" id="toggleControl" @checked($nhapCanh->is_khong_hang == 1)>
                            ...
                            <div class="row">
                                    ...
                                    <select class="form-control" id="loai-hang-dropdown-search" name="loai_hang">
                                        @foreach ($loaiHangs as $loaiHang)
                                            <option value="{{ $loaiHang->ten_loai_hang }}"
                                                @if ($nhapCanh->loai_hang == $loaiHang->ten_loai_hang) selected @endif>
                                    ...
                                    <select name="don_vi_tinh" class="form-control mt-2" id="don-vi-tinh-dropdown-search">
                                        ...
                                        @foreach ($donViTinhs as $donViTinh)
                                            <option value="{{ $donViTinh }}"
                                                @if ($nhapCanh->don_vi_tinh == $donViTinh) selected @endif>
                                                {{ $donViTinh }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-3">
                                    ...
                                    <input type="number" class="form-control" id="so-luong" name="so_luong"
                                        placeholder="Nhập số lượng hàng" required value="{{ $nhapCanh->so_luong }}">
                                </div>
                            ...
                            <div class="row">
                                <div class="form-group mt-1">
                                    ...
                                    <textarea class="form-control" id="ten-hang-hoa" name="ten_hang_hoa" placeholder="Nhập thông tin hàng hóa"
                                        rows="2">{{ $nhapCanh->ten_hang_hoa }}</textarea>
                                </div>
                            </div>
                            <div class="row">
                                <label class="label-text mb-1 fw-bold" for="">
                                ...
                                <select class="form-control mt-2" id="doanh-nghiep-dropdown-search">
                                    ...
                                    @foreach ($doanhNghieps as $doanhNghiep)
                                        @if ($doanhNghiep->ma_doanh_nghiep == $nhapCanh->ma_doanh_nghiep_chon)
            ...
            <center>
                ...
                <button id="xacNhanBtn" class="btn btn-success mt-5">Sửa tờ khai nhập cảnh</button>
            </center>
            </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Xác nhận sửa tờ khai nhập cảnh</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Xác nhận sửa tờ khai nhập cảnh này?
                </div>
                <div class="modal-footer">
                    <form action="{{ route('nhap-canh.sua-to-khai-nc-submit') }}" method="POST" id="mainForm"
                        name='xuatCanhForm'>
                        @csrf
                        <input type="hidden" name="ma_nhap_canh" id="ma_nhap_canh"
                            value="{{ $nhapCanh->ma_nhap_canh }}">
