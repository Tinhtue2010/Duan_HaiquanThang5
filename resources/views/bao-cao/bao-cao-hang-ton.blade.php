                ...
                <div class="container-fluid card-body">
                        ...
                        <div class="card p-3 ms-3 col-5">
                            ...
                            <div class="form-group">
                                <form action="{{ route('export.tiep-nhan-hang-ngay') }}" method="GET">
                                    ...
                                    <input type="text" id="datepicker15" class="form-control" placeholder="dd/mm/yyyy"
                    ...
                    <div class="row justify-content-center">
                        <div class="card p-3 me-3 col-5">
                            ...
                            <div class="form-group">
                                {{-- <form action="{{ route('export.theo-doi-tru-lui') }}" method="GET">
                                    <label class="label-text mb-2" for="ma_to_khai">Số tờ khai nhập</label>
                                    ...
                                    <label class="label-text mb-1 mt-2" for="">Chọn lần xuất cảnh</label>
                                    <select class="form-control" id="lan-xuat-canh-dropdown-search" name="so_to_khai_xuat"
                                        required>
                                        <option></option>
                                    </select>
                                    <input value=1 type="hidden" name="cong_viec"></input>
                                    <center><button type="submit" class="btn btn-primary mt-2">Tải xuống báo cáo</button>
                                    </center>
                                </form> --}}
                        ...
                        <div class="card p-3 ms-3 col-5">
                            ...
                            <div class="form-group">
                                <form action="{{ route('export.dang-ky-xuat-khau-hang-hoa') }}" method="GET">
                                    ...
                                    <select class="form-control" id="doanh-nghiep-dropdown-search-2" name="ma_doanh_nghiep"
                                        required>
                        ...
                        <div class="card p-3 ms-3 col-5">
                            ...
                            <div class="form-group">
                                <form action="{{ route('export.bao-cao-sang-cont-chuyen-tau') }}" method="GET">
                                    ...
                                    <select class="form-control" id="cong-chuc-dropdown-search-2" name="ma_cong_chuc">
                                        <option></option>
