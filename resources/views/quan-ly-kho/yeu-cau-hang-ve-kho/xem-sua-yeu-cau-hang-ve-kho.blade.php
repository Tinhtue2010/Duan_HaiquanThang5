    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
            <div class="row">
                ...
                @endif
                <div class="col-6">
                    <a class="return-link" href="/thong-tin-yeu-cau-hang-ve-kho/{{ $yeuCau->ma_yeu_cau }}">
                        <p>
                            < Quay lại danh sách yêu cầu đưa hàng trở lại kho ban đầu </p>
                    </a>
            ...
            <div class="card p-3">
                <div id="divPrint">
                    ...
                    <div class="float-end mb-2 d-flex align-items-center justify-content-center">
                        ...
                        @if ($yeuCau->file_name)
                            {{ $yeuCau->file_name }}
                            <a href="{{ route('quan-ly-kho.download-yeu-cau-hang-ve-kho', [$yeuCau->ma_yeu_cau]) }}">
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.duyet-sua-yeu-cau-hang-ve-kho') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="xacNhanHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-sua-yeu-cau-hang-ve-kho') }}" method="POST">
                    @csrf
