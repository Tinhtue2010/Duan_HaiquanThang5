...
@section('title', 'Thông tin yêu cầu kiểm tra hàng')
        ...
        <div class="container-fluid px-5 mt-3">
            <div class="row">
                ...
                <div class="col-6">
                    <a class="return-link" href="/danh-sach-yeu-cau-kiem-tra">
                        <p>
                            < Quay lại danh sách yêu cầu kiểm tra </p>
                    </a>
                </div>
                <div class="col-6">
                    @if ($yeuCau->file_name)
                        <a href="{{ route('quan-ly-kho.download-yeu-cau-kiem-tra', [$yeuCau->ma_yeu_cau]) }}">
                    ...
                    @if (trim($yeuCau->trang_thai) != '0')
                        <a href="{{ route('quan-ly-kho.in-phieu-kiem-tra-hang', ['ma_yeu_cau' => $yeuCau->ma_yeu_cau]) }}">
            ...
            <div class="card p-3">
                <div id="divPrint">
                    ...
                    <h2 class="text-center">YÊU CẦU KIỂM TRA HÀNG</h2>
                            ...
                            @foreach ($chiTiets as $index => $chiTiet)
                                <tr>
                                    ...
                                    @if ($yeuCau->trang_thai == '2')
                                        <td>
                                            <a
                                                href="{{ route('export.theo-doi-tru-lui', ['cong_viec' => 7, 'ma_yeu_cau' => $yeuCau->ma_yeu_cau, 'so_to_khai_nhap' => $chiTiet->so_to_khai_nhap]) }}">
                                                <center>
                            ...
                            @if (trim($yeuCau->trang_thai) == '1')
                                ...
                                @elseif (Auth::user()->loai_tai_khoan == 'Doanh nghiệp' &&
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <a
                                                href="{{ route('quan-ly-kho.sua-yeu-cau-kiem-tra', ['ma_yeu_cau' => $yeuCau->ma_yeu_cau]) }}">
                            ...
                            @elseif(trim($yeuCau->trang_thai) == '3')
                                ...
                                <div class="row">
                                    <center>
                                        <div class="col-6">
                                            <a
                                                href="{{ route('quan-ly-kho.xem-sua-yeu-cau-kiem-tra', ['ma_yeu_cau' => $yeuCau->ma_yeu_cau]) }}">
                                                <button class="btn btn-warning px-4">
                                                    <img class="side-bar-icon" src="{{ asset('images/icons/edit.png') }}">
                                                    Xem sửa đổi
                                                </button>
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.duyet-yeu-cau-kiem-tra') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <h5>Xác nhận duyệt yêu cầu kiểm tra hàng?</h5>
    ...
    <div class="modal fade" id="xacNhanHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-yeu-cau-kiem-tra') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="xacNhanTuChoiHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-huy-yeu-cau-kiem-tra') }}" method="POST">
                    @csrf
                    <div class="modal-body text-danger">
                        @if (Auth::user()->loai_tai_khoan == 'Cán bộ công chức' && Auth::user()->congChuc->is_yeu_cau == 1)
    ...
    <div class="modal fade" id="thayDoiCongChucModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.thay-doi-cong-chuc-kiem-tra') }}" method="POST">
                    <div class="modal-body">
