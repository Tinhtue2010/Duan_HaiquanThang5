...
@section('title', 'Quản lý yêu cầu kiểm tra hàng')
        ...
        <div class=" px-4">
            <div class="card shadow mb-4">
                <div class="card-header pt-3">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <h4 class="font-weight-bold text-primary">Danh sách yêu cầu kiểm tra hàng</h4>
                        </div>
                        <div class="col-3">
                            @if (Auth::user()->loai_tai_khoan == 'Doanh nghiệp')
                                <a href="{{ route('quan-ly-kho.them-yeu-cau-kiem-tra') }}"><button
            ...
            var table = $('#dataTable').DataTable({
                ...
                initComplete: function() {
                    ...
                    select.on('change', function() {
                        ...
                        localStorage.setItem('kiemTra', val);
