...
@section('title', 'Thông tin yêu cầu chuyển kiểm tra')
    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
            <div class="row">
                ...
                @endif
                <div class="col-6">
                    <a class="return-link" href="/thong-tin-yeu-cau-kiem-tra/{{ $yeuCau->ma_yeu_cau }}">
                        <p>
                            < Quay lại danh sách yêu cầu chuyển kiểm tra </p>
                    </a>
            ...
            <div class="card p-3">
                <div id="divPrint">
                    ...
                    <h2 class="text-center">YÊU CẦU CHUYỂN HÀNG SANG kiểm tra MỚI</h2>
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.duyet-sua-yeu-cau-kiem-tra') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="xacNhanHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-sua-yeu-cau-kiem-tra') }}" method="POST">
                    @csrf
