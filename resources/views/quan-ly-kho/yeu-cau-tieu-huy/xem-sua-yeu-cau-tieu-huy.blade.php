    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
            <div class="row">
                ...
                @endif
                <div class="col-6">
                    <a class="return-link" href="/thong-tin-yeu-cau-tieu-huy/{{ $yeuCau->ma_yeu_cau }}">
                        <p>
                ...
                <div id="divPrint">
                    ...
                    <div class="float-end mb-2 d-flex align-items-center justify-content-center">
                        @if ($suaYeuCau->file_name)
                            {{ $suaYeuCau->file_name }}
                            <a href="{{ route('quan-ly-kho.download-yeu-cau-tieu-huy', [$suaYeuCau->ma_yeu_cau, true]) }}">
                                <button class="btn btn-success float-end mx-1">Xem file đính kèm</button>
                    ...
                    <table class="table table-bordered mt-2" id="displayTable"
                        ...
                        <tbody>
                            @foreach ($chiTietSuas as $index => $chiTietSuaYeuCau)
                                <tr class="text-center">
                                    <td>{{ $index + 1 }}</td> <!-- Display index (1-based) -->
                                    <td>{{ $chiTietSuaYeuCau->so_to_khai_nhap }}</td>
                                    <td>{{ $chiTietSuaYeuCau->so_tau }}</td>
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.duyet-sua-yeu-cau-tieu-huy') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="xacNhanHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-sua-yeu-cau-tieu-huy') }}" method="POST">
                    @csrf
