...
@section('title', 'Thông tin yêu cầu tiêu hủy')
        ...
        <div class="container-fluid px-5 mt-3">
            <div class="row">
                ...
                <div class="col-6">
                    <a class="return-link" href="/danh-sach-yeu-cau-tieu-huy">
                        <p>
                            < Quay lại danh sách yêu cầu tiêu hủy </p>
                    </a>
                </div>
                <div class="col-6">
                    @if ($yeuCau->file_name)
                        <a href="{{ route('quan-ly-kho.download-yeu-cau-tieu-huy', [$yeuCau->ma_yeu_cau]) }}">
            ...
            <div class="card p-3">
                <div id="divPrint">
                    ...
                    <h2 class="text-center">YÊU CẦU TIÊU HỦY HÀNG</h2>
                            ...
                            @foreach ($chiTiets as $index => $chiTiet)
                                <tr>
                                    ...
                                    @if ($yeuCau->trang_thai == 'Đã duyệt')
                                        <td>
                                            <a
                                                href="{{ route('export.theo-doi-tru-lui', ['cong_viec' => 6, 'ma_yeu_cau' => $yeuCau->ma_yeu_cau, 'so_to_khai_nhap' => $chiTiet->so_to_khai_nhap]) }}">
                                                <center>
                    ...
                    <div class="card p-3">
                        <div class="text-center">
                            @if (trim($yeuCau->trang_thai) == 'Đang chờ duyệt')
                                ...
                                @elseif (Auth::user()->loai_tai_khoan == 'Doanh nghiệp' &&
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <a
                                                href="{{ route('quan-ly-kho.sua-yeu-cau-tieu-huy', ['ma_yeu_cau' => $yeuCau->ma_yeu_cau]) }}">
                            ...
                            @elseif(trim($yeuCau->trang_thai) == 'Đã duyệt')
                                ...
                                <h2 class="text-primary">Cán bộ công chức phụ trách: {{ $yeuCau->congChuc->ten_cong_chuc ?? '' }}
                                </h2>
                            ...
                            @elseif(trim($yeuCau->trang_thai) == 'Doanh nghiệp đề nghị sửa yêu cầu')
                                ...
                                <h2 class="text-primary">Cán bộ công chức phụ trách: {{ $yeuCau->congChuc->ten_cong_chuc ?? '' }}</h2>
                                <div class="row">
                                    <center>
                                        <div class="col-6">
                                            <a
                                                href="{{ route('quan-ly-kho.xem-sua-yeu-cau-tieu-huy', ['ma_yeu_cau' => $yeuCau->ma_yeu_cau]) }}">
                                                <button class="btn btn-warning px-4">
                                                    <img class="side-bar-icon"
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.duyet-yeu-cau-tieu-huy') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <h5>Xác nhận duyệt yêu cầu tiêu hủy hàng?</h5>
    ...
    <div class="modal fade" id="xacNhanHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-yeu-cau-tieu-huy') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="xacNhanTuChoiHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-huy-yeu-cau-tieu-huy') }}" method="POST">
                    @csrf
                    <div class="modal-body text-danger">
                        @if (Auth::user()->loai_tai_khoan == 'Cán bộ công chức' && Auth::user()->congChuc->is_yeu_cau == 1)
