...
@section('title', 'Thêm yêu cầu chuyển container')
...
@section('content')
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
            ...
            <div class="row">
                <div class="col-6">
                    <h2>Thêm yêu cầu chuyển container</h2>
                </div>
                <div class="col-6">
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.them-yeu-cau-container-submit') }}" method="POST" id="mainForm"
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateTableIndex() {
                $("#displayTableChiTiet tbody tr").each(function(index) {
