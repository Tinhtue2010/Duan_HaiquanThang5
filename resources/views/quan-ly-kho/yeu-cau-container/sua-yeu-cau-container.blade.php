...
@section('title', 'Sửa yêu cầu chuyển container')
...
@section('content')
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
            ...
            <a class="return-link" href="/danh-sach-yeu-cau-container">
                <p>
                    < Quay lại quản lý yêu cầu chuyển container</p>
            </a>
            <h2>Sửa yêu cầu chuyển container</h2>
            <div class="row">
                <div class="col-12">
                            ...
                            <div class="col-5">
                                <div class="form-group">
                                    ...
                                    <span><em class="fs-6"> (Danh sách sẽ không hiện các tờ khai nhập có yêu cầu chuyển
                                            container <em class="text-primary">đang chờ duyệt</em>)</em></span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{ route('quan-ly-kho.sua-yeu-cau-container-submit') }}" method="POST" id="mainForm"
    ...
    <script>
        $(document).ready(function() {
            ...
            const tableChiTiet = document.querySelector('#displayTableChiTiet tbody');
            const tableHangHoaBody = document.querySelector('#displayTableHangHoa tbody');

            // Function to update the table indexes
            ...
            function loadChiTiets() {
                ...
                const chiTietHangHoas = @json($chiTietHangHoas);
                ...
                chiTiets.forEach(chiTiet => {
                    ...
                    const newRow = `
                        <tr data-index="${rowIndex}">
                            ...
                            <td class="text-center">${chiTiet.so_container_goc || ''}</td>
                            <td class="text-center">${chiTiet.so_luong_chuyen || ''}</td>
                            <td class="text-center">${chiTiet.so_container_dich || ''}</td>
                            <td class="text-center">${chiTiet.so_to_khai_cont_moi || '' }</td>
                            <td class="text-center">${chiTiet.so_luong_ton_cont_moi || '0'}</td>
                            <td class="text-center">${chiTiet.so_luong_chuyen + chiTiet.so_luong_ton_cont_moi}</td>
                        </tr>
                    `;
                    tableBody.insertAdjacentHTML('beforeend', newRow);
                });

                chiTietHangHoas.forEach(chiTietHangHoa => {
                    rowIndex++;
                    const newRow2 = `
                        <tr data-index="${rowIndex}">
                    ...
                    `;
                    tableChiTiet.insertAdjacentHTML('beforeend', newRow2);
                });
                updateRowsData();
            }
            loadChiTiets();
            ...
            $("#doneButton").on("click", function() {
                $("#displayTableHangHoa tbody tr").each(function() {
                    ...
                    if (soLuong === 0 || soContainerMoi === "" || soContainerMoi === soContainer) {
                        return;
                    }
                    ...
                    $("#displayTableChiTiet tbody tr").each(function() {
                        ...
                        if (maHangCont === maHangCont2 && soContainer === soContainer2 &&
            ...
            function getYeuCauTableData() {
                ...
                $.ajax({
                    url: "/get-to-khai-trong-cont", // Laravel route
                    type: "GET",
