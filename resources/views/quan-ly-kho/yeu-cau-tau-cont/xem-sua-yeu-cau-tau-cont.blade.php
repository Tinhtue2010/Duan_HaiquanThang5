                        ...
                        <tbody class="clickable-row">
                            @foreach ($chiTietSuaYeuCaus as $index => $chiTietSuaYeuCau)
                                <tr class="text-center" data-chitiet='@json($chiTietSuaYeuCau)'>
                                    ...
                                    <td>{{ $chiTietSuaYeuCau->so_container_goc }}</br> ({{ $chiTietSuaYeuCau->tau_goc }})
                                    </td>
                                    <td>{{ $chiTietSuaYeuCau->so_luong_chuyen }}</td>
                                    <td>{{ $chiTietSuaYeuCau->so_container_dich }}</br>
                                        ({{ $chiTietSuaYeuCau->tau_dich }})
                                    </td>
                                    <td>
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.duyet-sua-yeu-cau-tau-cont') }}" method="POST">
                    @csrf
                    <div class="modal-body">
    ...
    <div class="modal fade" id="xacNhanHuyModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.huy-sua-yeu-cau-tau-cont') }}" method="POST">
                    @csrf
