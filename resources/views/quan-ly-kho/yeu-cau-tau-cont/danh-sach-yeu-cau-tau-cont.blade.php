...
@section('title', 'Quản lý yêu cầu chuyển container và tàu')
        ...
        <div class=" px-4">
            <div class="card shadow mb-4">
                <div class="card-header pt-3">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <h4 class="font-weight-bold text-primary">Danh sách yêu cầu chuyển container và tàu</h4>
                        </div>
                        <div class="col-3">
                            @if (Auth::user()->loai_tai_khoan == 'Doanh nghiệp')
                                <a href="{{ route('quan-ly-kho.them-yeu-cau-tau-cont') }}"><button
            ...
            $('#dataTable').DataTable({
                ...
                initComplete: function() {
                    ...
                    select.on('change', function() {
                        ...
                        localStorage.setItem('tauCont', val);
