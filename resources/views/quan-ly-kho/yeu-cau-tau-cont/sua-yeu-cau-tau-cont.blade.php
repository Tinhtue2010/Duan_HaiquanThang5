...
@section('title', 'Sửa yêu cầu chuyển container và tàu')
...
@section('content')
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
            ...
            <h2>Sửa yêu cầu chuyển container và tàu</h2>
            <div class="row">
                <div class="col-12">
    ...
    <div class="modal fade" id="xacNhanModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('quan-ly-kho.sua-yeu-cau-tau-cont-submit') }}" method="POST" id="mainForm"
                ...
                chiTietHangHoas.forEach(chiTietHangHoa => {
                    ...
                    const newRow2 = `
                        <tr data-index="${rowIndex}">
                            ...
                            <td class="text-center" hidden>${chiTietHangHoa.tau_dich || '' }</td>
