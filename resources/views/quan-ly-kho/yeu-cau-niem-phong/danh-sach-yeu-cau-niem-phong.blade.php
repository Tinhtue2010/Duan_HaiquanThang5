...
@section('title', 'Quản lý yêu cầu niêm phong')
        ...
        <div class=" px-4">
            <div class="card shadow mb-4">
                <div class="card-header pt-3">
                    ...
                    <div class="row">
                        <div class="col-9">
                            <h4 class="font-weight-bold text-primary">Danh sách yêu cầu niêm phong</h4>
                        </div>
                        <div class="col-3">
                            @if (Auth::user()->loai_tai_khoan == 'Doanh nghiệp')
                                <a href="{{ route('quan-ly-kho.them-yeu-cau-niem-phong') }}"><button
    ...
    <script>
        $(document).ready(function() {
            var table = $('#dataTable').DataTable({
                ...
                serverSide: true,
                stateSave: true,
                ajax: "{{ route('quan-ly-kho.getYeuCauNiemPhong') }}",
                ...
                createdRow: function(row, data, dataIndex) {
                    $(row).addClass('clickable-row').attr('onclick',
                        `window.location='{{ url('/thong-tin-yeu-cau-niem-phong') }}/${data.ma_yeu_cau}'`
                    );
                },
