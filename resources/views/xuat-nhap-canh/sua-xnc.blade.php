...
@section('content')
    ...
    <div id="layoutSidenav_content">
        <div class="container-fluid px-5 mt-3">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <select class="form-control" id="ptvt-xc-dropdown-search"
                                            ...
                                            @foreach ($PTVTXuatCanhs as $PTVTXuatCanh)
                                                @if ($PTVTXuatCanh->so_ptvt_xuat_canh == $xuatNhapCanh->so_ptvt_xuat_canh)
                                                    <option value="{{ $PTVTXuatCanh->so_ptvt_xuat_canh }}" selected>
                                ...
                                <div class="col-2">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="number" class="form-control" id="so-luong-may" name="so_luong_may"
                                            value="{{ $xuatNhapCanh->so_luong_may }}" placeholder="Nhập số lượng máy"
                                            required>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="number" class="form-control" id="tong-trong-tai" name="tong_trong_tai"
                                            value="{{ $xuatNhapCanh->trong_trong_tai }}" placeholder="Nhập tổng trọng tải"
                                            required>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="radio-group">
                                        ...
                                        @else
                                            ...
                                            <label class="radio-container">Hàng lạnh
                                                <input type="radio" name="radio1" checked="checked" value="2">
                                                <span class="checkmark"></span>
                                            </label>
                                        @endif
                                    </div>
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" id="thoi-gian-nhap-canh"
                                        ...
                                        value="{{ $xuatNhapCanh->thoi_gian_nhap_canh }}">
                                    ...
                                    <input type="text" class="form-control" id="thoi-gian-xuat-canh"
                                        ...
                                        value="{{ $xuatNhapCanh->thoi_gian_xuat_canh }}">
                                </div>
                                <div class="col-4">
                                    <label for="thoi_gian_nhap_canh" class="form-label">
                                    ...
                                    <textarea type="time" class="form-control" id="ghi-chu" rows="3" name="ghi_chu"
                                        placeholder="Nhập ghi chú" required>{{ $xuatNhapCanh->ghi_chu }}</textarea>
                                </div>
            ...
            <center>
                <button id="xacNhanBtn" class="btn btn-success mt-5">Sửa theo dõi</button>
            </center>
            </form>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Xác nhận sửa theo dõi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    Xác nhận sửa theo dõi xuất nhập cảnh này?
                </div>
                <div class="modal-footer">
                    <form action="{{ route('xuat-nhap-canh.sua-xnc-submit') }}" method="POST" id="mainForm"
                        name='xuatCanhForm'>
                        @csrf
                        ...
                        <button id="submitData" type="submit" class="btn btn-success">Sửa theo dõi</button>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            tongTrongTai.value = {{ $xuatNhapCanh->tong_trong_tai ?? 0 }};
