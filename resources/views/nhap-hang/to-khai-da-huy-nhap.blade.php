...
@section('title', 'Quản lý tờ khai đã hủy')
        ...
        <div class=" px-4">
            <div class="card shadow mb-4">
                <div class="card-header pt-3">
                    <div class="row">
                        <div class="col-9">
                            <h4 class="font-weight-bold text-primary">Danh sách tờ khai nhập đã hủy</h4>
                        </div>
                        <div class="col-3">
                        </div>
                    </div>
                            ...
                            <tbody class="clickable-row">
                                @foreach ($data as $index => $nhapHang)
                                    <tr class="clickable-row"
                                        onclick="window.location='{{ route('nhap-hang.show-huy', $nhapHang->id_huy) }}'">
                                        <td>{{ $index + 1 }}</td>
