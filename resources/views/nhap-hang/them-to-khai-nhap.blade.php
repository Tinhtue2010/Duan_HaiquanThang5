                    ...
                    <div class="card px-3 pt-3 mt-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" class="form-control mt-2" id="so_to_khai_nhap" maxlength="13"
                        ...
                        <div class="row">
                            <div class="col">
                                <label class="label-text mb-3" for="">Đại lý</label> <span
                                    class="text-danger missing-input-text"></span>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            nhapYeuCauButton.addEventListener('click', function() {
                ...
                if (soToKhaiNhap.length < 12) {
                    alert("Số tờ khai nhập phải có ít nhất 12 ký tự!");
                    return;
                }
